locals {
  database_to_paths = {
    "dl-raw-zone"      = "s3://tech-challanger-3-prd-raw-zone-593793061865/whether-minute/*.parquet"
    "dl-processing-zone" = "s3://tech-challanger-3-prd-processing-zone-593793061865/predict-next-hour-whether/*.parquet"
  }
}
